...
{
    /// <summary>
    /// Object containing ES data. The ESBuffer stores ESObjects it builds this out of data specified programmatically and the ESBuilder
    /// builds ESObjects from their text format.
    /// </summary>
