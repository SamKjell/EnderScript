...
{
    /// <summary>
    /// Object used to read ES data. Also used to parse ES from a string. 
    /// </summary>
    ...
    { 
        ...
        /// <summary>
        /// Creates a builder from a .es file rather than an es string.
        /// </summary>
        public static ESBuilder Create(string path)
        {
            return ESUtils.CreateBuilderFromPath(path);
        }
